...
public sealed class Ip2cService : IIp2cService
{
    ...
    //
    // Αυτό ΕΙΝΑΙ το anti-corruption layer: το raw string format του IP2C ζει και πεθαίνει
    // εδώ μέσα. Ο υπόλοιπος κώδικας (handler, controller) βλέπει μόνο Ip2cResult -
    // αν το IP2C αλλάξει το wire format αύριο, αλλάζει μόνο αυτή η μέθοδος.
